<x-layouts.app>
    <div class="mx-auto max-w-3xl space-y-6 p-6 lg:p-8">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">Edit Catalog Item</h1>
            <p class="text-sm text-zinc-600 dark:text-zinc-400">
                Update an existing media item in the catalog.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('catalog.update', $item) }}" class="space-y-6 rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        name="poster_path"
                        type="text"
                        value="{{ old('poster_path', $item->poster_path) }}"
                        class="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-zinc-900 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100"
                    >
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        value="{{ old('notification_label', $item->notification_label) }}"
