...
<div class="mx-auto max-w-3xl space-y-6 p-6 lg:p-8">
    ...
    <form wire:submit="save" class="space-y-6 rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <div>
                <label class="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-200">New Password</label>
            ...
            <div>
                <label class="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-200">Confirm New Password</label>
